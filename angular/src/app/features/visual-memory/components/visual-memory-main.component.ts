...
@Component({
  selector: 'app-visual-memory-main',
  template: `
    <div class="main-container">
      <h2>Основной этап теста</h2>
...
export class VisualMemoryMainComponent extends BaseTestComponent implements OnInit {
  isTestStarted = false;
  ...
  endTest(): void {
    ...
    this.saveResults();
    this.router.navigate(['/visual-memory/result']);
  }
} 